...
$(document).ready(function(ev){
    ...
    $('#custom_carousel3').on('slide.bs.carousel', function (evt) {
        
 
      $('#custom_carousel3 .controls li.active').removeClass('active');
      $('#custom_carousel3 .controls li:eq('+$(evt.relatedTarget).index()+')').addClass('active');
    })
    $('.nav').draggable({ 
        axis: "x",
         stop: function() {
...
$(document).ready(function(ev){
    ...
    $('#custom_carousel0').on('slide.bs.carousel', function (evt) {
